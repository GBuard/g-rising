...
export default function SaisieDuJour() {
    ...
    return (
        <div className="min-h-screen bg-[#1D1D1D] text-white px-3 sm:px-6 md:px-10 py-6 sm:py-8">
            <h2 className="text-2xl sm:text-3xl md:text-6xl text-center mb-16 sm:mb-40 mt-10 sm:mt-20">
            ...
            <form
                ...
                className="space-y-8 max-w-full sm:max-w-2xl md:max-w-6xl mx-auto"
            >
                {/* LIGNE 1 */}
